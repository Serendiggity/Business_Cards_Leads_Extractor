  ...
  if (!contacts || contacts.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <p className="text-gray-400">Upload some business cards to get started</p>
      </div>
    );
  }
              ...
              <TableCell>
                <div className="flex items-center">
                  <div className="flex-shrink-0 h-10 w-10">
                    <div className={`h-10 w-10 rounded-full flex items-center justify-center text-white font-medium ${getAvatarColor(contact.name)}`}>
