...
export function VerificationModal({ businessCard, isOpen, onClose, onSave }: VerificationModalProps) {
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            The OCR quality was low. Please review and correct the extracted information before saving.
          </DialogDescription>
        </DialogHeader>
